...
<a class="btn btn-xs btn-primary" title="Elimina las Udos con medición de proyecto CERO" href=# onclick="js_href( '../obras/obras_proy_delete.php?solo_udo_vacias=1&id_obra=<?php echo $id_obra;?>'  ,1, '¿Eliminar las Unidades de Obra (Udos), Capítulos y Subobras vacías?'  );"  >Eliminar Udos vacías</a><br>
