...
<h1>IMPORTAR MOVS. BANCOS DESDE .XLS (Cajasur)</h1>
...
<form action="mov_bancos_importar_XLS_cajasur.php?id_cta_banco=<?php echo $id_cta_banco ; ?>" id="form1" name="form1" method="POST" enctype="multipart/form-data">
...
<!--    <input type="checkbox" id="borrar_proyecto" name="borrar_proyecto" value="OFF"  />
    ...
    <table style="border: 1px solid black;">
        <tr><td colspan='10'><p>Copia/pega las celdas del XLS donde están los movimientos Bancarios al area de texto con el formato de columnas de abajo.</p>
                ...
                <p>formato XLS de Cajasur</p>
            </td></tr>

        <tr ><td>Fecha</td><td >Concepto</td><td>-no operativo</td><td>importe</td></tr>
    </table>
...
//       $CONTACTO=$c[8] ;  
//       $TEL1=$c[9] ;  
       $fecha_banco=dbDate($c[0]) ;  
       $concepto=quita_simbolos_mysql($c[1]) ;  
...
//       $id_subobra=DInsert_into("SubObras", "(ID_OBRA, SUBOBRA,user)", $values_insert , "ID_SUBOBRA", "ID_OBRA=$id_obra");
       ...
       // A MEDIAS , para evitar ver por dende iba cajasur e importar todo el panel XLS
