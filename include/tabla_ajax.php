...
$vars_vars=  [ "divs", "javascript_cargar", "sql_S","result_S", "tabla_sumatorias", "idtabla" ,"columna_ficha","chart_button","table_button","chart_ocultos","print_pdf","visibles"
...
unset( $divs,$tabla_sumatorias,$idtabla, $tabla_style, $tabla_footer,$add_link_html, $add_link,$sql, $sql_T, $sql_T2, $sql_T3,$sql_S,$result_S, $rst, 
