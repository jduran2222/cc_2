...
// coprobamos si estamos LOGUEADOS
if (!isset($_SESSION["id_c_coste"]))  // CONSULTAMOS SI ESTAMOS LOGUEADOS
{ 
//    header('Location: ../index.php'); 
    echo "ERROR: SESION CADUCADA";
}      // no estamos logueados ni traemos cadena de login, es decir, a Pantalla Index a loguearse.
else
{   // estamos logueados . continuamos con el UPDATE    
