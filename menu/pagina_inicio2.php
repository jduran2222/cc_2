...
echo "<br><br><br><br><br><a class='btn btn-xs btn-link noprint'  href='#'  onclick=\"tour()\"  title='Tour pruebas' >Tour (pruebas)</a>" ;
...
if (1)    // ACTIVIDAD lo ponemos para todos los usuarios  , juand, abril 2020
{
    ...
    echo " <div>"
    . "<a target='_blank' class='btn btn-link btn-lg' href='../agenda/eventos.php' > Actividad"
...
echo "<br><a class='btn btn-link btn-lg' target='_blank' href='../include/ficha_general.php?url_enc=".encrypt2("tabla=Licencias&id_update=id_licencia&no_update=1&id_valor=".$_SESSION["id_licencia"])."' >"
                  . "<i class='fas fa-key'></i> $msg_licencia</a>" ;
//echo "<br> $msg_licencia " ;   {$_SESSION["id_licencia"]}

// cambio empresa
if (is_multiempresa()) { echo "<br><a class='btn btn-link btn-lg' target='_blank' title='Cambiar a otra empresa a la que pertenezca el usuario' href='../menu/pagina_empresas.php' >"
    . "<i class='fas fa-exchange-alt'></i> cambiar empresa</a>" ; }

    
// cerrar sesion    
echo "<br><a class='btn btn-link btn-lg' href='../registro/cerrar_sesion.php' ><span class='glyphicon glyphicon-off'></span> Cerrar sesión</a>" ;
            ...
            <!--****************** #LICITACIONES  *****************-->
                <div class="col-sm-12 col-md-4  col-lg-3"> 
                    ...
                    <div id='div_estudios' class='collapse in'>         
                        ...
                        <br><a target="_blank" class="btn btn-link btn-lg"  href="../estudios/estudios_buscar.php" ><i class="fas fa-list"></i> Listado Estudios y Licitaciones</a>
                        <!--<br><a target="_blank" class="btn btn-link btn-lg"  href="../estudios/estudios_calendar.php?_m=<?php echo $_m; ?>&fecha=<?php echo date("Y-m-d"); ?>" ><i class="far fa-calendar-alt"></i> Calendario Licitaciones</a>-->
                        <br><a target="_blank" class="btn btn-link btn-lg"  href="../estudios/ofertas_clientes.php?_m=<?php echo $_m; ?>&fecha=<?php echo date("Y-m-d"); ?>" ><i class="far fa-calendar-alt"></i> Presupuestos a clientes</a>
...
?>
                ...
                <div class="col-sm-12 col-md-4  col-lg-3">
                    ...
                    <div id='div_obras' class='collapse in'>         
                        ...
                        <br><a target="_blank" class="btn btn-link btn-lg"  href="../obras/obras_buscar.php?_m=<?php echo $_m; ?>&tipo_subcentro=OGA" ><i class="fas fa-hard-hat"></i> Obras o Proyectos <?php echo "($num_obras)"; ?></a>
                        <br><a target="_blank" class="btn btn-link btn-lg"  href="../personal/partes.php" ><i class="far fa-calendar-alt"></i> Calendario de Partes</a>
...
-->
                ...
                <div class="col-sm-12 col-md-4  col-lg-3">
                    ...
                    <div id='div_configuracion' class='collapse in'>  
                        ...
                        <br><a target="_blank" class="btn btn-link btn-lg"  href="../documentos/documentos.php?_m=<?php echo $_m; ?>&clasificar=1" title='Documentación que se ha subido a la plataforma y aún no ha sido tramitada o archivada en su lugar. P. ej. la foto de albarán enviado opr movil desde la propia obra. '><i class="far fa-file-alt"></i>Docs. Pendientes de Clasificar<?php echo badge($num_documentos_pdte_clasif); ?> </a>
