...
<?php 
//[FJSL 2020-12-06] Comentado para no mostrar el resumen 
// <!--INICIO EXPAND DE RESUMENES  -->   


// <br>
// <button type='button' class='btn btn-xs btn-link noprint' id='exp_resumen' data-toggle='collapse' data-target='#div_resumen'>
//     Resumen de importes 
...
$agrupacionSeleccionada = 'ultimas_fras_reg';
...
$filtrosArr = array();
$filtrosArr['proveedor'] = $proveedor;
// $filtrosArr['N_OBRA'] = $N_OBRA;
$filtrosArr['n_fra'] = $n_fra;
$filtrosArr['NOMBRE_OBRA'] = $NOMBRE_OBRA;
$filtrosArr['fecha1'] = $fecha1;
$filtrosArr['fecha2'] = $fecha2;
$filtrosArr['MES'] = $MES;
$filtrosArr['Trimestre'] = $Trimestre;
$filtrosArr['Anno'] = $Anno;
$filtrosArr['importe1'] = $importe1;
$filtrosArr['importe2'] = $importe2;
$filtrosArr['grupo'] = $grupo;
$filtrosArr['observaciones'] = $observaciones;
$filtrosArr['metadatos'] = $metadatos;
$filtrosArr['path_archivo'] = $path_archivo;
...
$filtros = panelFiltrosFacturasProveedor($listado_global, $filtrosArr);
...
$agrupaciones = panelAgrupacionesFacturasProveedor($btnAgrupaciones,$agrupacionSeleccionada);
...
echo selectoresMenuFacturasProveedor($filtros,$operaciones,$agrupaciones,$resumen,$labels);
