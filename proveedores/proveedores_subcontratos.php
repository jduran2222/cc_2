...
$titulo = 'Proveedores Subcontratos';
...
if (!($id_proveedor=Dfirst( "ID_PROVEEDORES" ,"Proveedores"," $where_c_coste AND ID_PROVEEDORES={$_GET['id_proveedor']} " ))) {die("ERROR PROVEEDOR NO ENCONTRADO");}
